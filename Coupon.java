...
public class Coupon {
	...
	public Coupon(String couponTitle, String couponDescription, Double value, Integer creditType, String author,
			Date validTill, Date createdDate, Date updatedDate) {
		super();
		this.couponTitle = couponTitle;
		this.couponDescription = couponDescription;
		this.value = value;
